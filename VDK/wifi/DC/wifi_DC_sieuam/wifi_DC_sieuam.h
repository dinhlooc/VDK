...
<html>
  <head>
    ...
    <title>Cảm biến siêu âm và điều khiển động cơ DC</title>
  </head>
  <body>
    <h1>Khoảng cách đo được:</h1>
    <h2><p id="serialMonitor">Đang tải...</p></h2><br>
      ...
      function readSerial() {
        ...
        xhttp.onreadystatechange = function() {
          if (this.readyState == 4 && this.status == 200) {
            serialMonitor.innerHTML = this.responseText + " cm";
