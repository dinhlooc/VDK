...
<html>
  ...
  <body>
    ...
    <p id="joystickButtonStatus">Trạng thái nút nhấn joystick: ...</p>
    ...
    <script>
      ...
      function updateButtonStatus() {
        ...
        xhr.onreadystatechange = function(){
          if (this.readyState == 4 && this.status == 200){
            document.getElementById('joystickButtonStatus').innerText = 'Trạng thái nút nhấn joystick: ' + this.responseText;
            setTimeout(updateButtonStatus, 500);
          }
        };
        xhr.open('GET', '/readButton', true);
        xhr.send();
      }
